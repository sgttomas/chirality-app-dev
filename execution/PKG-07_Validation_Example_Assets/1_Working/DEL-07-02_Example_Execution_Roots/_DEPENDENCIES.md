...
| DEP-07-02-011 | DOWNSTREAM | INTERFACE | DELIVERABLE | DEL-08-02 (Dependencies.csv v3.1 Schema Linter) | LOW | Doubly conditional: requires human ruling + DEL-08-02 scope TBD. |
...
- DEL-08-03 and DEL-08-02 edges are conditional on TBD scope decisions. Recorded with Confidence=LOW.
