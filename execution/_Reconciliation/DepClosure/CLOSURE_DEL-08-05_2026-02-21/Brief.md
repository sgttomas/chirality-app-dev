# Brief -- AUDIT_DEP_CLOSURE Run: DEL-08-05
...
- **OUTPUT_REQUIREMENTS:** Write all outputs to execution/_Reconciliation/DepClosure/CLOSURE_DEL-08-05_2026-02-21/
...
|---|---|
| EXECUTION_ROOT | execution/ |
| SCOPE | DEL-08-05 (single deliverable) |
