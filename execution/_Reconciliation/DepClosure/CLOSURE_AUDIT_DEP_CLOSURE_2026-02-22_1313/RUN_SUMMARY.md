...
| SNAPSHOT_PATH | `execution/_Reconciliation/DepClosure/CLOSURE_AUDIT_DEP_CLOSURE_2026-02-22_1313/` |
...
Keep full-graph closure as audit truth and use blocker-subset execution path analysis for sequencing. If data-quality caveats are present, rerun DEPENDENCIES on affected deliverables and rerun AUDIT_DEP_CLOSURE.
