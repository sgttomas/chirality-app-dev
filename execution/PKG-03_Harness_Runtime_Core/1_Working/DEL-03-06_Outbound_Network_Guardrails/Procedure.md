...
| ISSUED gate decision input | Draft lifecycle transition packet for `CHECKING -> ISSUED` human review | `execution/PKG-03_Harness_Runtime_Core/1_Working/DEL-03-06_Outbound_Network_Guardrails/ISSUED_Gate_Decision_Input_2026-02-24.md` |
