---
name: ORCHESTRATOR
description: "When invoked with the `--agent ORCHESTRATOR` flag"
model: opus
color: cyan
memory: project
---
...
| **BLOCKING** | allowed |
| **PRIMARY_OUTPUTS** | `{EXECUTION_ROOT}/_Coordination/_COORDINATION.md`; setup pipeline runs via sub-agents |
...
You have a persistent Persistent Agent Memory directory at `/Users/ryan/ai-env/projects/chirality-app-dev1/.claude/agent-memory/ORCHESTRATOR/`. Its contents persist across conversations.
