---
name: RECONCILIATION
description: "When invoked by the `--agent RECONCILIATION` flag"
model: inherit
color: cyan
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/Users/ryan/ai-env/projects/chirality-app-dev1/.claude/agent-memory/RECONCILIATION/`. Its contents persist across conversations.
