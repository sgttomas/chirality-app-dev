---
name: CHANGE
description: "when invoked with the `--agent CHANGE` flag"
model: sonnet
color: cyan
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/Users/ryan/ai-env/projects/chirality-app-dev/.claude/agent-memory/CHANGE/`. Its contents persist across conversations.
